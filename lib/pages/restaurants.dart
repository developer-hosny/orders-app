...
import 'package:orders_app/widgets/search/search.dart';
import 'package:scoped_model/scoped_model.dart';
// import '../models/restaurant.dart';
// import '../models/user.dart';
import '../scope-models/main.dart';
import '../widgets/restaurants/ads_list.dart';
import '../widgets/restaurants/restaurant_card.dart';
import '../widgets/restaurants/offer_area.dart';
...
class _RestaurantsPageState extends State<RestaurantsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      drawer: SideDrawer(context), //_buildSideDrawer(context),
