import 'package:orders_app/models/user.dart';
...
mixin ConnectedUserModel on Model {
  ...
  void updateUserData(FirebaseUser user) async {
    ...
    updateScopedUserData(user.uid, user.email);
